...
uses
  ...
  ExtCtrls, Forms, DCDVBTuningPlugins, ComCtrls, ShellAPI, DCDVBShared;

const
  CLSID_TunerControlPropertyPageAbout: TGuid = '{71A290D9-E1AD-4895-A667-FA3D0520A7E4}';
...
initialization
  ...
  (
    TfrmPropAbout,
    CLSID_TunerControlPropertyPageAbout
  );
