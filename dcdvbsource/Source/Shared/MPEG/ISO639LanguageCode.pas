...
type
  TISO6392LanguageCode = array[0..2] of Char;
  PISO6392LanguageCode = ^TISO6392LanguageCode;

  TISO6392Language = record
    Code: TISO6392LanguageCode;
    Name: String;
    LCID: Cardinal;
  end;

const
  ISO_639_2_LANGUAGES_COUNT   = 500;

  ISO_639_2_LANGUAGES: array[0..ISO_639_2_LANGUAGES_COUNT -1] of TISO6392Language = (
    ...
    (Code: 'ath'; Name: 'Athapascan'; LCID: $0),
    (Code: 'aus'; Name: 'Australian'; LCID: $0),
    ...
    (Code: 'deu'; Name: 'German'; LCID: $07),
    (Code: 'nds'; Name: 'German'; LCID: $07),
    ...
    (Code: 'iro'; Name: 'Iroquoian'; LCID: $0),
    ...
    (Code: 'sal'; Name: 'Salishan'; LCID: $0),
    (Code: 'sam'; Name: 'Samaritan Aramaic'; LCID: $0),
    (Code: 'smi'; Name: 'Sami (Other)'; LCID: $3b),
  ...
  function GetFullISO639Name(AName: String): String;
...
begin
  ...
  begin
    if Result = UpperCase(ISO_639_2_LANGUAGES[i].Code) then
    begin
      if ISO_639_2_LANGUAGES[i].LCID = 0 then
      begin
        Result := ISO_639_2_LANGUAGES[i].Name;
      end else
      begin
        if GetLocaleInfo(ISO_639_2_LANGUAGES[i].LCID, LOCALE_SYSTEM_DEFAULT, @s, 256) > 0 then
        begin
          Result := String(s);
        end else
        begin
